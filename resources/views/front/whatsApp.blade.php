<div id="enquiryContainer">
    <div class="enquirySideBar" id="enquirySide">
        ...
        <a onclick="enquiryToggle(this.id)" aria-label="enquiry form" id="wa-bttn"><img src="{{url('/')}}/theme/images/WhatsApp.svg" alt="Whatsapp Icon"></a>

    </div>



    <form method="GET" action="https://web.whatsapp.com/send" class="sidebarForm d-none wassupfrm" id="whatsappForm">
            <h3 class="txt-primary">Whatsapp Details</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <input type="tel" name="phone_number" id="phone" placeholder="Phone *" required="" pattern="[0-9]{5,15}">
                </div>
                <input type="hidden" name="phone" value="+351 931 371 105" id="phone" placeholder="Phone *" required="">
            </div>
            <select name="text" id="purpose" required="">
